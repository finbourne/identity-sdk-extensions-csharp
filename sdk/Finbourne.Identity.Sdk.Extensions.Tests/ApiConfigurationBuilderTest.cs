...
namespace Finbourne.Identity.Sdk.Extensions.Tests
{
    ...
    {
        private const string APP = "IDENTITY";
        private string _secretsFile;
        private string _cachedTokenUrl;
        private string _cachedIdentityUrl;
        ...
        public void Setup()
        {
            ...
            _cachedIdentityUrl = Environment.GetEnvironmentVariable($"FBN_{APP}_API_URL") ??
        ...
        public void TearDown()
        {
            ...
            Environment.SetEnvironmentVariable($"FBN_{APP}_API_URL", _cachedIdentityUrl);
        ...
        public void Use_Secrets_File_If_It_Exists()
        {
            PopulateDummySecretsFile(new Dictionary<string, string>
            {
                ...
                {"identityUrl", string.Format("<{0}Url>", "identity")},
            });            
            ...
            Assert.That(apiConfiguration.IdentityUrl, Is.EqualTo(string.Format("<{0}Url>", "identity")));            
        }
        ...
        public void Use_Environment_Variables_If_No_Secrets_File_Provided()
        {
            ...
            Environment.SetEnvironmentVariable($"FBN_{APP}_API_URL", string.Format("<env.{0}Url>", "identity"));
            ...
            Assert.That(apiConfiguration.IdentityUrl, Is.EqualTo(string.Format("<env.{0}Url>", "identity")));            
        }
        ...
        public void Use_Configuration_Section_If_Supplied()
        {
            var settings = new Dictionary<string, string>
            {
                ...
                { "api:IdentityUrl", string.Format("<env.{0}Url>", "identity") },
        ...
        public void Throw_Exception_If_Configuration_Section_Incomplete()
        {
            ...
            {
                { "api:TokenUrl", "<tokenUrl>" },
                { "api:IdentityUrl", string.Format("<{0}Url>", "identity") },
                { "api:ClientId", "<clientId>" },
                { "api:ClientSecret", "" },
                { "api:Username", "<username>" },
                { "api:Password", "" },
